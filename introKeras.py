...
model.add(Dropout(0.3)) # dropout: rand 30% not used for training so NN is forced to train other 70%, prevents overfitting
# final classification as one of ten possibles according to softmax
model.add(Dense(10, activation = 'softmax'))
# Dense implements the acutal calculation of the matrices
